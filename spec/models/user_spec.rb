...
RSpec.describe User, type: :model do
  ...
  describe "micropost associations" do
    ...
    describe "status" do
      ...
      specify { expect(@user.feed.to_a).to include(newer_micropost) }
      specify {expect(@user.feed.to_a).to include(older_micropost) }
      specify {expect(@user.feed.to_a).not_to include(unfollowed_post) }
      specify do
        followed_user.microposts.each do |micropost|
          expect(@user.feed.to_a).to include(micropost)
        end
      end
    end
  end
